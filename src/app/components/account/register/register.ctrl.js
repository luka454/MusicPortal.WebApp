(function(){
	...
	function registerCtrl($scope, accountService, toastr){
		...
		$scope.register = function(){
			...
			/*if(!angular.equals($scope.confirmPassword, $scope.password)){
				$scope.rForm.confirmPassword.$setValidity('confirm', true);
			} else {
				$scope.rForm.confirmPassword.$setValidity('confirm', false);
			} */
